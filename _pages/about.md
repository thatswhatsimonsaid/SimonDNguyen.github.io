...
My current research focuses on improving model transparency and robustness in machine learning through the concept of predictive multiplicity. Specifically, I examine the Rashomon Set, a collection of diverse near-optimal models that offer multiple plausible explanations for the same data, to develop active learning algorithms that account for model ambiguity and prioritize conservative, robust decision-making. This work aims to address model uncertainty, enhancing both the interpretability and reliability of machine learning predictions.
